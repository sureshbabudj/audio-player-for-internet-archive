  ...
  return (
    <View className="flex-1 bg-darker">
      ...
      <ScrollView
        ...
        contentContainerClassName="pb-[150px] lg:pb-[60px]"
      >
        {/* Wave Animation */}
        ...
        {isEmpty ? (
          <View className="flex-1 mt-10">
            <EmptyState
              title="Welcome to ArchiPlay"
              message="Discover millions of free music, audiobooks, and radio programs from the Internet Archive. Search to begin your collection."
              actionLabel="Discover Content"
            />
          </View>
        ) : (
          <View className="lg:flex-row lg:px-4">
                ...
                <View className="px-6 mb-8">
                  ...
                  {recentlyPlayed.slice(0, 5).map((track) => (
                    <TrackItem
                      ...
                      onPress={() =>
                        loadTrack(track, recentlyPlayed, "Recent Plays")
                      }
                    />
                  ))}
                </View>
                ...
                <View className="px-6 mb-10">
                  ...
                  {mostlyPlayedTracks.map((track) => (
                    <TrackItem
                      ...
                      isCurrent={currentTrack?.id === track.id}
                      onPress={() =>
                        loadTrack(track, allTracks, "Mostly Played")
                      }
                    />
                  ))}
                </View>
