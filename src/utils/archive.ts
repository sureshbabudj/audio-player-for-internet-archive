...
export async function searchArchive(query: string, signal?: AbortSignal): Promise<ArchiveItem[]> {
...
export async function fetchItemTracks(item: ArchiveItem, signal?: AbortSignal): Promise<ArchiveTrack[]> {
